...
NEI.hide(<DCsAppleMilk:defeatedcrow.chopsticks>);
...
NEI.hide(<ExtraUtilities:spike_base_gold>);
...
NEI.hide(<ExtraUtilities:defoliageAxe>);
...
// Forestry
NEI.hide(<Forestry:canJuice>);
NEI.hide(<Forestry:waxCapsuleJuice>);
NEI.hide(<Forestry:refractoryJuice>);
NEI.hide(<Forestry:honeyPot>);
NEI.hide(<Forestry:ambrosia>);
